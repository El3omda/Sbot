...
client.on("message", (msg) => {
  ...
  if (msg.body == "أخري") {
    ...
    msg.reply(
      "برجاء مشاهدة هذا الفيديو علي قناتنا علي اليوتيوب واتباع الارشادات التي بة المنتج"
    );
    client.sendMessage(
      supportNo,
      'هناك عميل جديد قام بارسال بياناته "برمجة بوابة المنزل الذكي"'
    );
  } else if (msg.body == "مفتاح الانارة الذكي") {
    msg.reply(
      "برجاء مشاهدة هذا الفيديو علي قناتنا علي اليوتيوب واتباع الارشادات التي بة "
    );
    client.sendMessage(
      supportNo,
      'هناك عميل جديد قام بارسال بياناته "برمجة مفتاح الانارة الذكي"'
    );
  }
  ...
  if (msg.body == "مفتاح الانماط الذكية") {
    ...
    client.sendMessage(
      supportNo,
      'هناك عميل جديد قام بارسال بياناته "برمجة مفتاح الانماط الذكية"'
    );
  } else if (msg.body == "حساس حركة الابواب و النوافذ") {
    msg.reply(
      "برجاء مشاهدة هذا الفيديو علي قناتنا علي اليوتيوب واتباع الارشادات التي بة "
    );
    client.sendMessage(supportNo, "هناك عميل جديد قام بارسال بياناته \" برمجة حساس حركة الابواب و النوافذ \"");
  ...
  if (msg.body == "قفل الدخول الذكي") {
    ...
    msg.reply(
      "سوف يقوم الفني بزيارتك الرجاء تزويدنا بالبيانات التالية :\nالأسم\nرقم التواصل\nاسم المشروع\nرقم المبني\nرقم الوحدة"
    );
